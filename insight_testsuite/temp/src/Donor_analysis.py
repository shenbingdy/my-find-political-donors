...
import numpy as np
# ## Load Data
full=pd.read_csv('./input/itcont.txt',dtype={10: str,18: str},sep="|", header=None)
...
Input[Medianvals_date].to_csv('./output/medianvals_by_date.txt', header=True, index=False, sep='|')
